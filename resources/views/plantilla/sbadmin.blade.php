      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> 
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link"><span class="icon_title"><i class="nav-icon fas fa-cubes"></i></span><p class="menu_title">Módulos<i class="fas fa-angle-left right"></i></p></a>
            <ul class="nav nav-treeview"> 
              <li class="nav-item has-treeview"><a href="#" class="nav-link"><i class="fas fa-angle-right nav-icon"></i><p>Empresa<i class="right fas fa-angle-left"></i></p></a>
                <ul class="nav nav-treeview">
                  <li @click="menu=17" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Datos</p></a></li>
                  <li @click="menu=18" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Locales</p></a></li>              
                </ul>
              </li>             
              <li class="nav-item has-treeview"><a href="#" class="nav-link"><i class="fas fa-angle-right nav-icon"></i><p>Inscripciones<i class="right fas fa-angle-left"></i></p></a>
                <ul class="nav nav-treeview">                     
                  <li @click="menu=19" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Horarios</p></a></li> 
                  <li @click="menu=20" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Modalidades</p></a></li>
                  <li @click="menu=21" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Rutinas</p></a></li> 
                  <li @click="menu=22" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Calendarios</p></a></li>               
                </ul>
              </li>
              <li class="nav-item has-treeview"><a href="#" class="nav-link"><i class="fas fa-angle-right nav-icon"></i><p>Personas<i class="right fas fa-angle-left"></i></p></a>
                <ul class="nav nav-treeview">
                  <li @click="menu=23" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Especialidades</p></a></li>
                  <li @click="menu=24" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Universidades</p></a></li>
                  <li @click="menu=25" class="nav-item"><a href="#" class="nav-link "><i class="fas fa-angle-double-right nav-icon"></i><p>Profesiones</p></a></li>                
                </ul>
              </li>               
            </ul>
          </li>         
