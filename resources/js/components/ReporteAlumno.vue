                        ...
                        <div class="card-body">
                            <div class="form-group row justify-content-between">
                                <div class="input-group input-group-sm col-8">                                
                                    <select class="form-control col-4 " v-model="criterio" onchange="ceroBusqueda();">
                ...
                <div class="col-md-6">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="form-group row justify-content-between">
                                <div class="input-group input-group-sm col-8">                                
                                    <select class="form-control col-4 " v-model="criterio_">
                                    ...
                                    <button type="submit" @click="listarVentasCabeceraAlumno(1,buscar_,criterio_,paginado_)" class="btn btn-primary btn-sm"><i class="fas fa-search"></i> Buscar</button>                                 
                                </div>
                                <div class="col-2"></div>
                                <div class="input-group input-group-sm col-2">                                     
  ...
  export default {
    ...
    methods : {
      ...
      listarVentasCabeceraAlumno(page_,buscar_,criterio_,paginado_){
        let me=this;
        var url= '/venta/listarVentasCabeceraAlumno?page_='+page_+'&buscar_='+buscar_+'&criterio_='+criterio_+'&paginado_='+paginado_;
        axios.get(url).then(function (response) {
            var respuesta= response.data;
