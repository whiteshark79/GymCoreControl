                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-sm btn-primary btn-sm" @click="abrirModal('categoria','registrar')"><i class="icon-plus">  Nueva Categoría</i></button>
                            </div>
                        </div>                      
                            ...
                            <div class="form-group row justify-content-between">
                                <div class="row col-sm-12 col-md-12">
                                    <div class="input-group input-group-sm col-sm-11 col-md-11">                                
                                        ...
                                        <input type="text" v-model="buscar" @keyup.enter="listarCategoria(1,buscar,criterio,paginado,ordenado,ascdesc)" class="form-control col-sm-3 col-md-3" placeholder="Texto a buscar">
                                        <button type="submit" @click="listarCategoria(1,buscar,criterio,paginado,ordenado,ascdesc)" class="btn btn-primary btn-sm"><i class="icon-magnifier"></i> Buscar</button>
                                ...
                                <table class="table table-bordered table-sm table-hover" id="dtTable">
                                    ...
                                    <tbody v-if="arrayCategoria.length">
                                        <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                            <td v-text="categoria.id" align="center" scope="row" data-label="#"></td>
                                            <td v-text="categoria.nombre" data-label="NOMBRE"></td>
                                            <td v-text="categoria.descripcion" data-label="DESCRIPCIÓN"></td>
                                            ...
                                            <td align="center" data-label="ACCIONES">                                                                                
                                                ...
                                                <template v-else>
                                                    <a class="btn btn-sm btn-default" @click="activarCategoria(categoria.id)"><i class="icon-check" title="Actualizar"></i></a>
                                                </template>
                                            </td>
                                        </tr>
                                    </tbody>
