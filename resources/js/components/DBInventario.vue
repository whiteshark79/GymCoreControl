                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row justify-content-between">
                        <div class="input-group input-group-sm col-10">                                
                            ...
                            <input type="text" v-model="buscar" @keyup.enter="listarArticuloVenta(1,buscar,criterio,paginado)" class="form-control col-5" placeholder="Texto a buscar">
        ...
        methods : {
            ...
            loadArticulos(){
                ...
                me.articulos.map(function(x){
                    ...
                    me.backgroundcolor.push('rgba('+me.varBackgroundColor+',0.2)');
            ...
            cambiarPagina(page,buscar,criterio,paginado){
                ...
                me.listarVenta(page,buscar,criterio,paginado);
            },
