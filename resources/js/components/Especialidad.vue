                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-sm btn-primary btn-sm" @click="abrirModal('especialidad','registrar')"><i class="fas fa-plus-circle">  Nueva Especialidad</i></button>
                            </div>
                        </div>                      
                        ...
                        <div class="card-body">
                            <div class="form-group row justify-content-between">
                                <div class="input-group input-group-sm col-7">                                
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarEspecialidad(1,buscar,criterio,paginado,ordenado,ascdesc)" class="form-control col-4" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarEspecialidad(1,buscar,criterio,paginado,ordenado,ascdesc)" class="btn btn-primary btn-sm"><i class="fas fa-search"></i> Buscar</button>                                 
                                </div>
                                <div class="col-4"></div>
                                ...
                                <table class="table table-bordered table-sm table-hover" id="dtTable">
                                    ...
                                    <tbody v-if="arrayEspecialidad.length">
                                        <tr v-for="especialidad in arrayEspecialidad" :key="especialidad.id">
                                            <td v-text="especialidad.id" align="center"></td>
                                            ...
                                            <td align="center">
                                                <a class="btn btn-sm btn-default" @click="abrirModal('especialidad','actualizar',especialidad)"><i class="fas fa-edit" title="Editar"></i></a>                                   
                                                <template v-if="especialidad.condicion">
                                                    <a class="btn btn-sm btn-default" @click="desactivarEspecialidad(especialidad.id)"><i class="fas fa-ban" title="Desactivar"></i></a>
                                                </template>
                                                <template v-else>
                                                    <a class="btn btn-sm btn-default" @click="activarEspecialidad(especialidad.id)"><i class="fas fa-sync" title="Actualizar"></i></a>
                                                </template>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    export default {
        ...
        methods : {
            ...
            validarEspecialidad(){
                ...
                if (!this.nombre) this.errorMostrarMsjEspecialidad.push("El nombre de la especialidad no puede estar vacío.");
