                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div v-show="errorClasificacion" class="form-group row div-error">
                                <div class="text-center text-error">
                                    <div v-for="error in errorMostrarMsjClasificacion" :key="error" v-text="error">
                                    </div>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarClasificacion(){
                ...
                if (!this.nombre) this.errorMostrarMsjClasificacion.push("El nombre de la categoría no puede estar vacío.");
