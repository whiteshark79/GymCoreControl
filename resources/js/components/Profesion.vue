                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-sm btn-primary btn-sm" @click="abrirModal('profesion','registrar')"><i class="icon-plus">  Nueva Profesión</i></button>
                            </div>
                        </div>                      
                            ...
                            <div class="form-group row justify-content-between">
                                <div class="row col-sm-12 col-md-12">
                                    <div class="input-group input-group-sm col-sm-11 col-md-11">                                
                                        ...
                                        <input type="text" v-model="buscar" @keyup.enter="listarProfesion(1,buscar,criterio,paginado,ordenado,ascdesc)" class="form-control col-sm-3 col-md-3" placeholder="Texto a buscar">
                                        <button type="submit" @click="listarProfesion(1,buscar,criterio,paginado,ordenado,ascdesc)" class="btn btn-primary btn-sm"><i class="icon-magnifier"></i> Buscar</button>                                 
                                ...
                                <table class="table table-bordered table-sm table-hover" id="dtTable">
                                    ...
                                    <tbody v-if="arrayProfesion.length">
                                        <tr v-for="profesion in arrayProfesion" :key="profesion.id">
                                            <td v-text="profesion.id" align="center" scope="row" data-label="#"></td>
                                            <td v-text="profesion.nombre" data-label="NOMBRE"></td>
                                            <td v-text="profesion.descripcion" data-label="DESCRIPCIÓN"></td>
                                            ...
                                            <td align="center" data-label="ACCIONES">
                                                <a class="btn btn-sm btn-default" @click="abrirModal('profesion','actualizar',profesion)"><i class="icon-note" title="Editar"></i></a>                                 
                                                <template v-if="profesion.condicion">
                                                    <a class="btn btn-sm btn-default" @click="desactivarProfesion(profesion.id)"><i class="icon-ban" title="Desactivar"></i></a>
                                                </template>
                                                <template v-else>
                                                    <a class="btn btn-sm btn-default" @click="activarProfesion(profesion.id)"><i class="icon-check" title="Actualizar"></i></a>
                                                </template>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input type="text" v-model="nombre" maxlength="60" class="form-control" v-bind:class="{ 'is-invalid': e_nombre }">
                            </div>
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
    ...
    export default {
        ...
        methods : {
            ...
            validarProfesion(){
                ...
                if (!this.nombre) {this.e_nombre = true; this.errorMostrarMsjProfesion.push('nombre');}else{this.e_nombre = false}
                if (!this.descripcion) {this.e_descripcion = true; this.errorMostrarMsjProfesion.push('descripcion');}else{this.e_descripcion = false}
