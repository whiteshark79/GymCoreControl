                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-sm btn-primary btn-sm" @click="abrirModal('provincia','registrar')"><i class="icon-plus">  Nueva Provincia</i></button>
                            </div>
                        </div>                      
                            ...
                            <div class="form-group row justify-content-between">
                                <div class="row col-sm-12 col-md-12">
                                    <div class="input-group input-group-sm col-sm-11 col-md-11">                                
                                        ...
                                        <button type="submit" @click="listarProvincia(1,buscar,criterio,paginado,ordenado,ascdesc)" class="btn btn-primary btn-sm"><i class="icon-magnifier"></i> Buscar</button>                                 
                                    ...
                                    <tbody v-if="arrayProvincia.length">
                                        <tr v-for="provincia in arrayProvincia" :key="provincia.id">
                                            ...
                                            <td align="center" data-label="ACCIONES">
                                                <a class="btn btn-sm btn-default" @click="abrirModal('provincia','actualizar',provincia)"><i class="icon-note" title="Editar"></i></a>                                   
                                                <template v-if="provincia.condicion">
                                                    <a class="btn btn-sm btn-default" @click="desactivarProvincia(provincia.id)"><i class="icon-ban" title="Desactivar"></i></a>
                                                </template>
                                                <template v-else>
                                                    <a class="btn btn-sm btn-default" @click="activarProvincia(provincia.id)"><i class="icon-check" title="Actualizar"></i></a>
                                                </template>
                                            </td>
                                        </tr>
                                    </tbody>
