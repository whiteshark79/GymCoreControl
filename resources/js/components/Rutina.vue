                        ...
                        <div class="card-body">
                            <div class="form-group row justify-content-between">
                                <div class="input-group input-group-sm col-7">                                
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarRutina(1,buscar,criterio,paginado,ordenado,ascdesc)" class="form-control col-4" placeholder="Texto a buscar">
                                ...
                                <table class="table table-bordered table-sm table-hover" id="dtTable">
                                    ...
                                    <tbody v-if="arrayRutina.length">
                                        <tr v-for="rutina in arrayRutina" :key="rutina.id">
                                            <td v-text="rutina.id" align="center"></td>
                                            <td v-text="rutina.nombre"></td>
                                            <td v-text="rutina.descripcion"></td>                                            
                                            <td align="center">
