                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-sm btn-primary btn-sm" @click="abrirModal('local','registrar')"><i class="icon-plus">  Nuevo Local</i></button>
                            </div>
                        </div>                      
                            ...
                            <div class="form-group row justify-content-between">
                                <div class="row col-sm-12 col-md-12">
                                    <div class="input-group input-group-sm  col-sm-11 col-md-11">                                
                                        ...
                                        <button type="submit" @click="listarLocal(1,buscar,criterio,paginado,ordenado,ascdesc)" class="btn btn-primary btn-sm"><i class="icon-magnifier"></i> Buscar</button>                                 
                                    ...
                                    <tbody v-if="arrayLocal.length">
                                        <tr v-for="local in arrayLocal" :key="local.id">
                                            ...
                                            <td align="center" data-label="ACCIONES">
                                                <a class="btn btn-sm btn-default" @click="abrirModal('local','actualizar',local)"><i class="icon-note" title="Editar"></i></a>                                   
                                                <template v-if="local.condicion">
                                                    <a class="btn btn-sm btn-default" @click="desactivarLocal(local.id)"><i class="icon-ban" title="Desactivar"></i></a>
                                                </template>
                                                <template v-else>
                                                    <a class="btn btn-sm btn-default" @click="activarLocal(local.id)"><i class="icon-check" title="Actualizar"></i></a>
                                                </template>
                                            </td>
                                        </tr>
                                    </tbody>
